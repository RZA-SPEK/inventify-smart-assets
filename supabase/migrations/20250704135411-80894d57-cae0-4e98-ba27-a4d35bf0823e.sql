...
-- Fix the get_current_user_role function to remove any potential role references
...
-- Fix check_maintenance_due function to remove any potential role references
...
-- Fix check_warranty_expiry function to remove any potential role references
...
-- Fix notify_admins_new_reservation function to remove any potential role references
